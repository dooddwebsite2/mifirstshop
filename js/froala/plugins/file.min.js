...
! function (i) {
    ...
    C.extend(C.FE.POPUP_TEMPLATES, {
        ...
        function g() {
            ...
            e || (e = E()), e.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), e.find(".fr-file-progress-bar-layer").addClass("fr-active"), e.find(".fr-buttons").hide(), o(f.language.translate("Uploading"), 0)
        }
        ...
        function a(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                var t, i = e[0];
                if (null === f.opts.fileUploadURL || f.opts.fileUploadURL == p) return s = i, (l = new FileReader).addEventListener("load", function () {
                ...
                if (f.drag_support.formdata && (t = f.drag_support.formdata ? new FormData : null), t) {
                    ...
                    if (!1 !== f.opts.fileUploadToS3)
                        for (r in t.append("key", f.opts.fileUploadToS3.keyStart + (new Date).getTime() + "-" + (i.name || "untitled")), t.append("success_action_status", "201"), t.append("X-Requested-With", "xhr"), t.append("Content-Type", i.type), f.opts.fileUploadToS3.params) f.opts.fileUploadToS3.params.hasOwnProperty(r) && t.append(r, f.opts.fileUploadToS3.params[r]);
                    ...
                    o.onload = function () {
                        m.call(o, i.name)
                    }, o.onerror = b, o.upload.onprogress = y, o.onabort = S, g();
        ...
        function E(e) {
            ...
            return r = o, f.events.$on(r, "dragover dragenter", ".fr-file-upload-layer", function () {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (i && "undefined" != typeof i.type) {
                    if (i.type.indexOf("image") < 0) {
                        ...
                        f.markers.remove(), f.markers.insertAtPoint(e.originalEvent), f.$el.find(".fr-marker").replaceWith(C.FE.MARKERS), f.popups.hideAll();
                        var r = f.popups.get("file.insert");
                        return r || (r = E()), f.popups.setContainer("file.insert", f.$sc), f.popups.show("file.insert", e.originalEvent.pageX, e.originalEvent.pageY), g(), a(t.files), e.preventDefault(), e.stopPropagation(), !1
                    }
        ...
        function w() {
            ...
            if (r)
                for (e = 0; e < r.length; e++) i.indexOf(r[e].getAttribute("href")) < 0 && f.events.trigger("file.unlink", [r[e]]);
            r = t
        }
        return i[1] = "File cannot be loaded from the passed link.", i[l] = "No link in upload response.", i[d] = "Error during file upload.", i[u] = "Parsing response failed.", i[c] = "File is too large.", i[v] = "File file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", {
            _init: function () {
                ...
                }), f.events.on("link.beforeRemove", e), f.$wp && (w(), f.events.on("contentChanged", w)), E(!0)
            },
            showInsertPopup: function () {
                var e = f.$tb.find('.fr-command[data-cmd="insertFile"]'),
                    t = f.popups.get("file.insert");
                if (t || (t = E()), n(), !t.hasClass("fr-active"))
